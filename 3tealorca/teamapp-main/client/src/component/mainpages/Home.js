  ...
  return (
    <div className='home'>
      ...
      <p>The Indian Premier League <abbr>(IPL)</abbr> is a professional men's Twenty20 cricket league, contested by ten teams based out of ten Indian cities.[1] The league was founded by the Board of Control 
        ...
        <img src="https://gumlet.assettype.com/barandbench%2F2021-05%2F4097be4e-5be3-44f2-82fa-64ef48221a1e%2FIPL.jpg?auto=format%2Ccompress&fit=max&format=webp&w=768&dpr=1.0"alt='ipl'/> 
        <p>
